...
| **Spell Name**          | **Effect**                                                                                                                 | **Range** | **TN** | **Scaling Options** |
| ----------------------- | -------------------------------------------------------------------------------------------------------------------------- | --------- | ------ | ------------------- |
| **Meteor Crash**        | *4D6 Fire damage in a 30ft radius, ignites terrain for Burning (2 rounds).*                                            | 60ft      | 14     | Damage, Area        |
| **Thunderstorm**        | *3D6 Lightning damage to all creatures in a 30ft radius.*                                                                  | 30ft      | 14     | Damage, Area        |
| **Glacial Spear**       | *3D6 Cold damage, inflicts Frozen (1 round, TN 14 to resist).*                                                         | 40ft      | 14     | Damage, Duration    |
| **Arcane Barrage**      | *Fires three force projectiles, each dealing 2D6 damage.*                                                                  | 40ft      | 14     | Damage, Range       |
| **Hurricane Spiral**    | *3D6 Slashing damage in a 30ft radius, lifts creatures into air.*                                                          | 30ft      | 14     | Damage, Area        |
| **Hellfire Cage**       | *3D6 Fire damage, traps creatures in 10ft Burning walls (2 rounds).*                                                   | 40ft      | 14     | Damage, Duration    |
| **Draconic Maelstrom**  | *4D6 Fire damage in a 30ft cone, burns for Burning (2 rounds).*                                                        | 30ft cone | 14     | Damage, Area        |
| **Stormcaller’s Wrath** | *4D6 Lightning damage, strikes up to 3 targets.*                                                                           | 50ft      | 14     | Damage, Range       |
| **Avalanche Breaker**   | *3D6 Cold damage in a 25ft cone, knocks creatures Prone (TN 14 to resist).*                                            | 25ft cone | 14     | Damage, Area        |
| **Solar Annihilation**  | *4D6 Radiant damage in a 40ft radius, inflicts Blinded (1 round, TN 14 to resist).*                                    | 40ft      | 14     | Damage, Duration    |
| **Tectonic Collapse**   | *4D6 Bludgeoning damage in a 30ft radius, collapses unstable ground, creating a pit that lasts until filled.*          | 30ft      | 14     | Damage, Area        |
| **Volcanic Eruption**   | *4D6 Fire damage in a 20ft radius, leaves Molten Terrain (2 rounds), inflicts Burning (1 round, TN 14 to resist).* | 30ft      | 14     | Damage, Area        |
### **Illusion Spells**

| **Spell Name**       | **Effect**                                                                                                  | **Range** | **TN** | **Scaling Options**                                                                     |
| -------------------- | ----------------------------------------------------------------------------------------------------------- | --------- | ------ | --------------------------------------------------------------------------------------- |
| **Phantom Sound**    | *Create a realistic but illusory sound within range. Cannot cause physical harm. Lasts 1 min.*              | 30ft      | 8      | **Range**, **Duration**, **Effect**: Louder and more complex sounds with additional SP. |
| **Minor Image**      | *Create a small static visual illusion (object, symbol, or image). Cannot move or make noise. Lasts 1 min.* | 20ft      | 10     | **Range**, **Area**, **Effect**: Allows small movements or simple animations.           |
| **Blur**             | *The caster’s image distorts, giving attackers Disadvantage for 1 minute.*                                  | Self      | 12     | **Duration**                                                                            |
| **Distract**         | *A targeted creature glances away, giving the next attack against them Advantage.*                          | 15ft      | 10     | **Range**, **Effect**: Can distract multiple creatures per SP spent.                    |
| **False Echoes**     | *Your voice seems to come from multiple locations, confusing listeners. Lasts 30 sec.*                      | 30ft      | 10     | **Range**, **Effect**: Can project multiple voices or distort meaning.                  |
| **Shadow Step**      | *Briefly step into a shadow, reappearing 5ft away.*                                                         | 5ft       | 10     | **Range**                                                                               |
| **Mirror Trick**     | *A fake illusory duplicate of yourself appears in your space. Disappears when touched. Lasts 1 min.*        | Self      | 12     | **Effect**: Can move **5ft per turn** independently per SP spent.                       |
| **Obscuring Veil**   | *Wrap yourself in illusory mist, making ranged attacks suffer Disadvantage for 1 min.*                      | Self      | 10     | **Duration**                                                                            |
| **Conceal Object**   | *An object up to 1ft in size appears invisible for 5 min.*                                                  | Touch     | 10     | **Size**, **Duration**                                                                  |
| **Displace Figure**  | *Your form shifts unpredictably, giving attackers Major Disadvantage for 3 rounds.*                         | Self      | 12     | **Duration**                                                                            |
| **Glamour Mask**     | *Alter minor facial features, voice, or hair for 10 min.*                                                   | Self      | 10     | **Duration**, **Effect**: Allows larger physical alterations per SP spent.              |
| **Flickering Image** | *Your form flickers unpredictably, giving you Disadvantage on enemy Perception checks. Lasts 1 min.*        | Self      | 12     | **Effect**: Can turn fully invisible for 1 round per SP spent.                          |
| **Silence**          | *Creates a 10ft zone of magical silence for 1 minute. No sound can be made in this area.*                   | 20ft      | 12     | **Area**, **Duration**                                                                  |
| **Major Image**      | *Create a larger illusion (creature-sized) with movement and sound. Lasts 1 min.*                           | 30ft      | 12     | **Area**, **Effect**: Can interact with environment per SP spent.                       |
| **Hallucination**    | *A target sees a convincing illusion for 1 minute. Requires direct sight.*                                  | 30ft      | 12     | **Effect**: Can affect multiple creatures per SP spent.                                 |
| **Veil of Shadows**  | *Gain Advantage on Stealth checks for 10 min.*                                                              | Self      | 10     | **Duration**                                                                            |
| **Doppelgänger**     | *Summon a perfect illusory clone of yourself. Mimics actions but cannot interact physically. Lasts 1 min.*  | Self      | 12     | **Effect**: Can act semi-independently per SP spent.                                    |
| **Phantom Pain**     | *A target feels a false but intense pain, causing Disadvantage on all attacks for 3 rounds.*                | 20ft      | 12     | **Effect**: Can stun for 1 turn per SP spent.                                           |
| **False Passage**    | *Creates a realistic illusory doorway, bridge, or tunnel that disappears upon interaction. Lasts 10 min.*   | 40ft      | 10     | **Size**, **Duration**                                                                  |
| **Invisibility**     | *Turn one creature or object invisible for 1 minute.*                                                       | Touch     | 12     | **Duration**, **Effect**: Can be extended to more creatures per SP spent.               |
| **Shadow Bind**      | *A target’s shadow grips them, halving their movement for 3 rounds.*                                        | 20ft      | 12     | **Effect**: Can fully immobilize per SP spent.                                          |
| **Muffled Step**     | *Mutes your footsteps and movement for 5 min.*                                                              | Self      | 10     | **Duration**                                                                            |
| **Illusory Terrain** | *Make a 10ft area appear different (pit, floor, water, etc.) for 10 min.*                                   | 30ft      | 12     | **Area**, **Duration**                                                                  |
| **False Sunlight**   | *Create a blinding flash, imposing Disadvantage on all attacks for 2 rounds.*                               | 30ft      | 12     | **Effect**: Can cause **Blindness** for 1 round per SP spent.                           |
